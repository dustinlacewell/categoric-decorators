...
export declare const createClassCategoric: <T = undefined, D = T extends undefined ? () => (target: Constructable) => void : (data: T) => (target: Constructable) => void>() => readonly [D, () => CategoricClassMetas<T>];
